...
/*vamos a crear un programa que se encargue de cifrar un archivo de texto
a traves del cifrado DES utilizando las librerias ce crypto y security
de java para atender los cifrados simetricos y asimetricos
    
vamos a recibir como parametro un archivo txt, ais como una clave*/

public class EjemploDES {
    
    public static void main(String[] args) throws Exception{
        
        /* Lo primero que vamos a hacer es comprobar si tenemos cargado el fichero
        o archivo de texto que vamos a cifrar */
        ...
        /* lo primero que tenemos que hacer es cargar el tipo de instancia o proveedor
        del cifrado simetrico que se va a utilizar */
        
        System.out.println("1.- Generar la clave DES: ");
        //la llave la podemos crear a partir de una funcion generica llamada funcion hash MD5
        //una secuencia de numeros pseudoaleatorios
        KeyGenerator generadorDES=KeyGenerator.getInstance("DES");
        
        //inicializar llave
        //llavde de DES 56 bits
        //tamaño de la llave
        ...
        //entraba a las 16 rondas con las subllaves, esta es para generar esas subllaves
        ...
        System.out.println("2.- Cifrar con DES el fichero "+args[0]+", dejar el resultado en: "+args[0]+".cifrado");
        ...
        //terminar de leer el tamaño del archivo
        ...
        System.out.println("3.- Descifrar con DES el fichero "+args[0]+".cifrado"+", dejar el resultado en: "+args[0]+".descifrado");
    ...
    public static void mensajeAyuda() {
        ...
        System.out.println("Ejemplo de un cifrado DES utilizando librerios Crypto y Security");
